...
final class IndexedFile {
    ...
    /// Lowercase source extension used for per-format timing summaries.
    var fileExtension: String?

    /// End-to-end indexing duration for this file, in milliseconds.
    var indexingDurationMs: Double?

    /// Short local-VLM title for images. Empty for non-image records.
    var visualTitle: String?

    /// Local-VLM explanation used by the Image Index table and preview.
    var visualExplanation: String?
    ...
    init(
        ...
        self.indexingDurationMs = indexingDurationMs
        self.visualTitle = visualTitle
        self.visualExplanation = visualExplanation
    }
}
